...
const profiles = {
  'tesla-fsd-us-current': {
    ...
    notes: 'OpenODC 社区已按 2026-05-13 可访问的 Tesla 官方 Model Y 2026.14 北美车主手册、FSD Supervised 说明页与 FSD v14 Trial 官方说明复核。本条为美国市场 FSD（Supervised）当前公开样例，不再固定为早期版本；Tesla 官方说明显示 FSD v14 Trial 需要 FSD（Supervised）14.2 或更高版本。该样例仍不是 Tesla 官方 ODC 声明。手册可高置信支撑驾驶员持续监管、FSD 激活速度 <85 mph (140 km/h)、车灯/雨刮/摄像头/安全带/接管等条件；天气、曲率、坡度等没有量化阈值，不能推定为完整 ODD。',
  ...
  'tesla-assisted-driving-china-current': {
    ...
    notes: 'OpenODC 社区已按 2026-05-13 可访问的 Tesla 官方中国区 Model Y 2026.14 车主手册复核。中国区 2026.14 手册章节为“辅助驾驶功能”，包括主动巡航控制、智能辅助转向、智能泊车、召唤功能和辅助驾驶限制/警告；本条不使用北美中文手册，也不把北美 FSD（Supervised）能力套用到中国市场。手册可高置信支撑驾驶员持续监管、车道线/天气/施工/安全带等限制；未公开 mm/h、曲率半径、坡度等量化 ODC。',
  ...
  'huawei-ads4-aito-m9': {
    ...
    notes: 'OpenODC 社区已按 2026-05-13 可访问的 AITO 官方 M9 产品页、配置表和 2026-03-17 版官方使用说明书复核。本条是问界 M9 2025 款 ADS 4 辅助驾驶样例，不等同于 2026-04-23 发布的 ADS 5，也不包含监管试点中的 L3 能力。手册可高置信支撑 NCA 适用道路、驾驶员责任、NCA 最高目标车速 130 km/h、初始目标车速下限 30 km/h、新手考试/里程条件、脱手检测与降级逻辑；雨雪雾没有 mm/h 或能见度量化阈值。',
  ...
  'baidu-apollogo-wuhan': {
    ...
    notes: 'OpenODC 社区已按 2026-05-13 可访问的武汉经开区政府文件、武汉智能交通试点公告、Apollo Go 官方入口与 RT6 官方发布稿复核。本条为武汉示范运营样例；Robotaxi 没有车主手册，权威证据优先级为政府运营规则、示范应用管理文件、官方运营规则和 App 实时电子围栏。公开网页不能支撑统一运行速度上限、具体雨量/能见度停运阈值或完整乘客年龄规则，因此这些项目保留为公开资料未明确或中置信运营规则线索。',
  ...
  'pony-ai-gen7-robotaxi': {
    ...
    notes: 'OpenODC 社区已按 2026-05-13 可访问的小马智行官网、IR 官方 PDF、深圳前海政府页面和硬件合作方资料复核。本条可高置信支撑 Gen-7 全无人商业化运营城市、L4 Robotaxi 服务属性、车内无安全员、硬件/算力方向；具体 geofence、速度上限、天气停运阈值、乘客规则和远程协助 SOP 未公开。',
  ...
  'xpeng-xngp-p7plus-2026': {
    ...
    notes: 'OpenODC 社区已按 2026-05-13 可访问的小鹏 P7+ 官方产品页、配置表、官方新闻稿和官方社区指南复核。本条为 L2 辅助驾驶样例。官方页面可支撑 P7+ AI 辅助驾驶硬件、城市/高速 NGP、车位到车位、人机共驾、AEB/AES 130 km/h 等主动安全参数和驾驶员责任提示；公开资料未给出 XNGP 统一运行速度上限、雨量/能见度/坡度等量化 ODC 阈值。',
